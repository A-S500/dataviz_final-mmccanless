...
EDIT2: A bar chart where the y axis shows percentage of total balance sheet for each accounting category and the fill for the bars show percent change over 5 years. Facet wrap into one figure that can be displayed in paper.
